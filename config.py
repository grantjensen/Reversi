class TrainingConfig():
    def __init__(self):
        ...
        self.episodes=20  # number of games to train on per iteration (default=100)
        self.pitgames=20  # half the number of self play games performed after each training  (default=20)
        self.mctsSims=1  # number of mcts simulations to update policy both during episode generation and self play (default=25)
